...
\begin{center}
    \Large{\textbf{\underline{Lab Assignment-1 by Subhankar(LEADER)}}
    \end{center}
    \vspace{1cm}
   \begin{center}
...
\begin{center}
    \Large{\textbf{\underline{Lab Assignment-2 by Gloria}}}
\end{center}
...
\begin{center}
    \LARGE{\textbf{\underline{Lab Assignment-3 by Sresta}}}
\end{center}
\vspace{0.2cm}
 \begin{center}
...
\begin{center}
    \textbf{\underline{\large{Lab Assignment-4 by Sourav}}}
\end{center}
\begin{center}
...
\section{Methods}
This section describes the methods used in the study or analysis.

\subsection{Data Collection}
Details about how the data was collected are discussed here.

\subsubsection{Survey Method}
This subsubsection provides specifics on the survey method used for data collection.

\section{Results}
This section presents the results of the study or analysis.

\subsection{Analysis}
Details about the analysis of the results are provided in this subsection.

\subsubsection{Statistical Analysis}
This subsubsection focuses on the statistical methods used to analyze the data.

\section{Conclusion}
The final section summarizes the findings and provides conclusions.
...
\begin{tikzpicture}[remember picture,overlay]
    \draw[line width=4pt] 
        ($(current page.north west) + (0.3in,-0.3in)$) 
        rectangle 
        ($(current page.south east) + (-0.3in,0.3in)$);
\end{tikzpicture}

\section{\underline{Explanation}}

\begin{itemize}
    \item \texttt{\textbackslash section\{\}}: Creates a new section and numbers it accordingly. It is the highest level of sectioning in the \texttt{article} class.
    \item \texttt{\textbackslash subsection\{\}}: Creates a subsection under the current section. It is numbered as part of the section number (e.g., 1.1, 1.2).
    \item \texttt{\textbackslash subsubsection\{\}}: Creates a subsubsection under the current subsection. It is numbered as part of the subsection number (e.g., 1.1.1, 1.1.2).
\end{itemize}
...
\end{tikzpicture}
 \begin{center}
     \textbf{\underline{\large{Lab Assignment-5 by Aakash}}}
     \end{center}
     \vspace{0.5cm}
\begin{center}
